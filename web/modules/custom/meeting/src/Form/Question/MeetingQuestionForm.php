...
class MeetingQuestionForm extends FormBase
{
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $id=NULL)
  {
    ...
    $form['fields']['box']['row']['message'] = [
      '#type' => 'markup',
      '#markup' => '<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 result-question-message"></div>'
    ];
    ...
    $form['fields']['box']['row']['title'] = [
      ...
      '#required' => true,
      '#size' => 60,
      '#default_value' => (isset($question['title'])) ? $question['title'] : '',
      '#maxlength' => 128,
      '#wrapper_attributes' => ['class' => 'col-xs-12 col-sm-12 col-md-12 col-lg-12'],
      '#attributes' => ['placeholder' => 'Question title', 'class' => ['col-full']],
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state)
  {
    ...
    $question = $query->select('question', 'q')->fields(null, ['meeting_id'])
    ...
    if($question){
      ...
      $query->insert('question')->fields($data)->execute();
    }
